...
- `constants.tsx/` — explain what lives here and when agents should edit it.
- `data/` — explain what lives here and when agents should edit it.
- `deploy-lxc.sh/` — explain what lives here and when agents should edit it.
...
- `index.css/` — explain what lives here and when agents should edit it.
